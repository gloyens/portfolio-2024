...
import TitleBar from "@/app/(portfolio)/components/TitleBar";
import MenuBar from "@/app/(portfolio)/components/MenuBar";
import { enableDrag } from "@/app/(portfolio)/utils/dragElement";
